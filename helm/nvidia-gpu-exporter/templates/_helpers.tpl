...
app.kubernetes.io/part-of: {{ include "nvidia-gpu-exporter.name" . }}
{{- end }}
...
The image to use
*/}}
{{- define "nvidia-gpu-exporter.image" -}}
...
*/}}
{{- define "nvidia-gpu-exporter.namespace" -}}
...
*/}}
{{- define "nvidia-gpu-exporter.monitor-namespace" -}}
{{- if .Values.namespaceOverride }}
{{- .Values.namespaceOverride }}
{{- else }}
